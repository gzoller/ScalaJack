...
package msgpack.test.primitives
...
case class SampleEnum(e1: Size.Value, e2: Size.Value, e3: Size.Value, e4: Size.Value)
...
// === Java
case class SampleJBigDecimal(bd1: JBigDecimal, bd2: JBigDecimal, bd3: JBigDecimal, bd4: JBigDecimal, bd5: JBigDecimal)
case class SampleJBigInteger(bi1: JBigInteger, bi2: JBigInteger, bi3: JBigInteger, bi4: JBigInteger, bi5: JBigInteger, bi6: JBigInteger, bi7: JBigInteger)
case class SampleJBoolean(bool1: JBoolean, bool2: JBoolean, bool3: JBoolean, bool4: JBoolean, bool5: JBoolean)
case class SampleJByte(b1: JByte, b2: JByte, b3: JByte, b4: JByte, b5: JByte)
case class SampleJChar(c1: JChar, c2: JChar, c3: JChar)
case class SampleJDouble(d1: JDouble, d2: JDouble, d3: JDouble, d4: JDouble, d5: JDouble)
case class SampleJFloat(f1: JFloat, f2: JFloat, f3: JFloat, f4: JFloat, f5: JFloat)
...
case class SampleInstant(i1: Instant, i2: Instant, i3: Instant, i4: Instant, i5: Instant)
