...
class MsgPackUnsupportedType(msg: String) extends Throwable(msg) with NoStackTrace
class MsgPackUnexpectededType(msg: String) extends Throwable(msg) with NoStackTrace
class MsgPackParseError(msg: String) extends Throwable(msg) with NoStackTrace
...
// case class MsgPackTypeError(override val msg: String) extends ParseError(msg) with NoStackTrace:
