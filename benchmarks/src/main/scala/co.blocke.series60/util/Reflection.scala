...
object Reflection {
  ...
  //
  // Solve: co.blocke.series60.test.OuterTrait[co.blocke.series60.test.InnerTrait[Z],co.blocke.series60.test.InnerTrait[X],P] --> co.blocke.series60.test.OuterTrait[co.blocke.series60.test.InnerTrait[Char],co.blocke.series60.test.InnerTrait[Boolean],Int] :: Z
  // Solve: co.blocke.series60.test.InnerTrait[Z] --> co.blocke.series60.test.InnerTrait[Char] :: Z
  // Solve: Z --> Char :: Z
  // Solve: co.blocke.series60.test.InnerTrait[X] --> co.blocke.series60.test.InnerTrait[Boolean] :: Z
  // Solve: X --> Boolean :: Z
  // Solve: P --> Int :: Z
  //
  ...
  def populateChildTypeArgs(parentType: Type, childTypeBeforeSubstitution: Type): Type = {
    if (childTypeBeforeSubstitution.typeSymbol.isParameter) {
      ...
      //
      // parentTypeArgs                          = List(co.blocke.series60.test.InnerTrait[Char], co.blocke.series60.test.InnerTrait[Boolean], Int)
      // childTypeParams                         = List(type Z, type X, type P)
      // childAsParentTypeArgsBeforeSubstitution = List(co.blocke.series60.test.InnerTrait[Z], co.blocke.series60.test.InnerTrait[X], P)
      ...
      // co.blocke.series60.test.OuterTrait[co.blocke.series60.test.InnerTrait[Char],co.blocke.series60.test.InnerTrait[Boolean],Int]
