...
case class SjCaseClass( name:String, fields:List[SjField], ctor:MethodMirror, isTrait:Boolean = false ) extends SjType
...
case class SjValueClass( name:String, vcType:SjType, vFieldName:String, isTypeParam:Boolean ) extends SjType
