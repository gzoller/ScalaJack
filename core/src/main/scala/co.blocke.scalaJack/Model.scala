...
case class SjCaseClassProxy( name:String, params:List[String], fields:List[SjField], mappedTraitParams:LinkedHashMap[String,SjType] ) extends SjType with ParamProxy
...
case class SjTraitProxy( name:String, paramSymbols:List[String] ) extends SjType with ParamProxy
...
case class SjValueClassProxy( name:String, vcType:SjType, vFieldName:String ) extends SjType with ParamProxy
