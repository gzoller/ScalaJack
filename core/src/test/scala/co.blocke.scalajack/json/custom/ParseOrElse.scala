...
class ParseOrElse() extends FunSpec with Matchers {
  ...
  describe("-----------------------\n:  ParseOrElse Tests  :\n-----------------------") {
    it("Provide a default object if the object specified in the type hint is unknown") {
      ...
      val js = """{"_hint":"co.blocke.scalajack.json.custom.USDemographic","age":50,"address":{"_hint":"co.blocke.scalajack.json.custom.UnknownAddress","street":"123 Main","city":"New York","state":"NY","postalCode":"39822"}}"""
