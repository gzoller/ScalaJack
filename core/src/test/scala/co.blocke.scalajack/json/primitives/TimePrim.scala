    ...
    "--------------------------\n:  Time Primitive Tests  :\n--------------------------"
      ...
      describe("+++ Positive Tests +++") {
        ...
        it("Instant must work") {
          ...
          val js = sj.render(inst)
          assertResult(
            """{"i1":"1970-01-01T00:00:00Z","i2":"+1000000000-12-31T23:59:59.999999999Z","i3":"-1000000000-01-01T00:00:00Z","i4":"2007-12-03T10:15:30Z","i5":null}"""
          ) {
              js
            }
          assertResult(inst) {
        ...
        it("LocalDateTime must work") {
          ...
          val js = sj.render(inst)
          assertResult(
            """{"d1":"+999999999-12-31T23:59:59.999999999","d2":"-999999999-01-01T00:00:00","d3":"2007-12-03T10:15:30","d4":null}"""
          ) { js }
          assertResult(inst) {
        ...
        it("LocalDate must work") {
          ...
          val js = sj.render(inst)
          assertResult(
            """{"d1":"+999999999-12-31","d2":"-999999999-01-01","d3":"2007-12-03","d4":null}"""
          ) { js }
          assertResult(inst) {
        ...
        it("LocalTime must work") {
          ...
          val js = sj.render(inst)
          assertResult(
            """{"d1":"23:59:59.999999999","d2":"00:00:00","d3":"00:00:00","d4":"12:00:00","d5":"10:15:30","d6":null}"""
          ) { js }
          assertResult(inst) {
        ...
        it("OffsetDateTime must work") {
          ...
          val js = sj.render(inst)
          assertResult(
            """{"o1":"+999999999-12-31T23:59:59.999999999-18:00","o2":"-999999999-01-01T00:00:00+18:00","o3":"2007-12-03T10:15:30+01:00","o4":null}"""
          ) { js }
          assertResult(inst) {
        ...
        it("OffsetTime must work") {
          ...
          val js = sj.render(inst)
          assertResult(
            """{"o1":"23:59:59.999999999-18:00","o2":"00:00:00+18:00","o3":"10:15:30+01:00","o4":null}"""
          ) { js }
          assertResult(inst) {
        ...
        it("ZonedDateTime must work") {
          ...
          val js = sj.render(inst)
          assertResult(
            """{"o1":"2007-12-03T10:15:30+01:00[Europe/Paris]","o2":null}"""
          ) { js }
          assertResult(inst) {
      ...
      describe("--- Negative Tests ---") {
        it("Duration must break") {
          ...
          val msg2 = """Failed to parse Duration from input 'bogus'
                     ...
                     |------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleDuration](js2) should have message msg2
        }
        it("Instant must break") {
          ...
          val msg2 =
            """Failed to parse Instant from input 'bogus'
                     ...
                     |----------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleInstant](js2) should have message msg2
        }
        it("LocalDateTime must break") {
          ...
          val msg2 =
            """Failed to parse LocalDateTime from input 'bogus'
                     ...
                     |------------^""".stripMargin
          the[ScalaJackError] thrownBy sj
            .read[SampleLocalDateTime](js2) should have message msg2
        }
        it("LocalDate must break") {
          ...
          val msg = """Expected a String here
                    |{"d1":-1,"d2":"-999999999-01-01","d3":"2007-12-03","d4":null}
                    |------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleLocalDate](js) should have message msg
          val js2 =
          ...
          val msg2 =
            """Failed to parse LocalDate from input 'bogus'
                     |{"d1":"bogus","d2":"-999999999-01-01","d3":"2007-12-03","d4":null}
                     |------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleLocalDate](js2) should have message msg2
        }
        it("LocalTime must break") {
          ...
          val msg =
            """Expected a String here
                    ...
                    |----------------------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleLocalTime](js) should have message msg
          val js2 =
          ...
          val msg2 =
            """Failed to parse LocalTime from input 'Bogus'
                     ...
                     |----------------------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleLocalTime](js2) should have message msg2
        }
        it("OffsetDateTime must break") {
          ...
          val msg2 =
            """Failed to parse OffsetDateTime from input '-999999999-01T00:00:00+18:00'
                     ...
                     |----------------------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj
            .read[SampleOffsetDateTime](js2) should have message msg2
        }
        it("OffsetTime must break") {
          ...
          val msg =
            """Expected a String here
                    |{"o1":"23:59:59.999999999-18:00","o2":false,"o3":"10:15:30+01:00","o4":null}
                    |--------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleOffsetTime](js) should have message msg
          val js2 =
          ...
          val msg2 =
            """Failed to parse OffsetTime from input '00:00:00:00+18:00'
                     ...
                     |----------------------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleOffsetTime](js2) should have message msg2
        }
        it("Period must break") {
          ...
          val msg2 = """Failed to parse Period from input 'bogus'
                     ...
                     |-----------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SamplePeriod](js2) should have message msg2
        }
        it("ZonedDateTime must break") {
          ...
          val msg2 =
            """Failed to parse ZonedDateTime from input '2007-12-03T10:15:30+01:00 Earth'
                     ...
                     |--------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj
            .read[SampleZonedDateTime](js2) should have message msg2
        }
      }
    }
}
