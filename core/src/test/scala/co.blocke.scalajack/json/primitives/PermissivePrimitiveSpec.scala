...
class PermissivePrimitiveSpec() extends FunSpec with Matchers {
  ...
  describe("----------------------------\n:  Permissive Primitives Tests  :\n----------------------------") {
    it("Boolean must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.lang.Boolean]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Byte must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.lang.Byte]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Double must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.lang.Double]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Float must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.lang.Float]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Int must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.lang.Integer]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Long must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.lang.Long]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Short must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.lang.Short]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Scala BigInt must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[BigInt]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Java BigInteger must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.math.BigInteger]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Scala BigDecimal must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[BigDecimal]]("""{"value":""}"""), Path.Root \ "value", List("End")))
    ...
    it("Java BigDecimal must work") {
      ...
      assert(expectUnexpected(() => sj.read[Holder[java.math.BigDecimal]]("""{"value":""}"""), Path.Root \ "value", List("End")))
