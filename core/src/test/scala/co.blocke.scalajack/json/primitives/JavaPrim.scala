    ...
    "--------------------------\n:  Java Primitive Tests  :\n--------------------------"
      ...
      describe("+++ Positive Tests +++") {
        ...
        it("Int must work") {
          ...
          val js = sj.render(inst)
          assertResult(
            """{"i1":2147483647,"i2":-2147483648,"i3":0,"i4":123,"i5":null}"""
          ) { js }
          assertResult(inst) {
        ...
        it("Short must work") {
          ...
          val js = sj.render(inst)
          assertResult("""{"s1":32767,"s2":-32768,"s3":0,"s4":123,"s5":null}""") {
            js
          }
          assertResult(inst) {
      ...
      describe("--- Negative Tests ---") {
        ...
        it("Boolean must break") {
          ...
          val msg =
            """Expected a Boolean here
                    ...
                    |-------------------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj
            .read[SampleJBoolean](js) should have message msg
        }
        it("Byte must break") {
        ...
        it("Char must break") {
          ...
          val msg2 = """Tried to read a Character but empty string found
                     |{"c1":"Z","c2":"","c3":null}
                     |----------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleJChar](js2) should have message msg2
        }
        ...
        it("Float must break") {
          ...
          val msg =
            """Expected a Number here
                    |{"f1":3.4028235E38,"f2":"1.4E-45","f3":0.0,"f4":-123.4567,"f5":null}
                    |------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleJFloat](js) should have message msg
        }
        it("Int must break") {
          val js =
          ...
          val msg =
            """Expected a Number here
                    |{"i1":2147483647,"i2":-2147483648,"i3":false,"i4":123,"i5":null}
                    |---------------------------------------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleJInt](js) should have message msg
          val js2 =
            """{"i1":2147483647,"i2":-2147483648,"i3":0.3,"i4":123,"i5":null}"""
          the[java.lang.NumberFormatException] thrownBy sj.read[SampleJInt](js2) should have message "For input string: \"0.3\""
        }
        it("Long must break") {
          val js =
            """{"l1":9223372036854775807,"l2":-9223372036854775808,"l3":"0","l4":123,"l5":null}"""
          ...
          the[java.lang.NumberFormatException] thrownBy sj.read[SampleJLong](js2) should have message "For input string: \"0.3\""
        }
        ...
        it("Short must break") {
          ...
          val msg = """Expected a Number here
                    ...
                    |------^""".stripMargin
          the[ScalaJackError] thrownBy sj.read[SampleJShort](js) should have message msg
          val js2 = """{"s1":2.3,"s2":-32768,"s3":0,"s4":123,"s5":null}"""
          the[java.lang.NumberFormatException] thrownBy sj.read[SampleJShort](js2) should have message "For input string: \"2.3\""
        }
      }
    }
}
