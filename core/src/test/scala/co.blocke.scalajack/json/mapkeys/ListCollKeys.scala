  ...
  describe(
    "------------------------\n:  List Map Key Tests  :\n------------------------"
      ...
      it("List of Maps as key") {
        ...
        val js = sj.render(inst)
        assertResult(
          """{"[{\"wow\":true},{\"ya\":false}]":[{"zing":false},{"bling":true}]}"""
        ) { js }
        assertResult(inst) {
      ...
      it("List of Case Class as key") {
        ...
        val js = sj.render(inst)
        assertResult(
          """{"[{\"name\":\"Flipper\",\"food\":\"Meat\",\"waterTemp\":68.9},{\"name\":\"Flipper\",\"food\":\"Meat\",\"waterTemp\":68.9}]":[{"name":"Flipper","food":"Meat","waterTemp":68.9},{"name":"Flipper","food":"Meat","waterTemp":68.9}]}"""
        ) {
            js
          }
        assertResult(inst) {
      ...
      it("List of Any as key") {
        ...
        assertResult(true) {
          sj.read[Map[List[Any], List[Any]]](js)
      ...
      it("List of parameterized class as key") {
        ...
        val js = sj.render(inst)
        assertResult(
          """{"[{\"a\":true,\"b\":\"True\"},{\"a\":false,\"b\":\"False\"}]":[{"a":true,"b":"Yes"},{"a":false,"b":"No"}]}"""
        ) { js }
        assertResult(true) {
          sj.read[Map[List[AThing[String, Boolean]], List[AThing[String, Boolean]]]](js)
      ...
      it("List of parameterized trait as key") {
        ...
        val js = sj.render(inst)
        assertResult(
          """{"[{\"_hint\":\"co.blocke.scalajack.json.mapkeys.AThing\",\"a\":true,\"b\":\"True\"},{\"_hint\":\"co.blocke.scalajack.json.mapkeys.AThing\",\"a\":false,\"b\":\"False\"}]":[{"_hint":"co.blocke.scalajack.json.mapkeys.AThing","a":true,"b":"Yes"},{"_hint":"co.blocke.scalajack.json.mapkeys.AThing","a":false,"b":"No"}]}"""
        ) {
            js
          }
        assertResult(true) {
          sj.read[Map[List[Thing[Boolean, String]], List[Thing[Boolean, String]]]](js)
