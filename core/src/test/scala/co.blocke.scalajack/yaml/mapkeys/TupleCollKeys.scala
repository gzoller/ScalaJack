...
class TupleCollKeys() extends AnyFunSpec with Matchers {
  ...
  describe(
    ...
    it("Tuple of Optional as key") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj.read[SampleTupleOptional](yaml)
      }
    }
    ...
    it("Complex class (having members that are classes) as key") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj.read[SampleTupleComplex](yaml)
      }
    }
    it("Class having collections as members") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj.read[SampleTuplePolyClass](yaml)
      }
    }
    it("Class having collections as members (empty collections") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj.read[Map[(PolyClass, PolyClass), (PolyClass, PolyClass)]](yaml)
      }
    }
    it("Custom trait hint field and value for key trait") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj2.read[Map[(Pet, Pet), (Pet, Pet)]](yaml)
      }
    }
    it("Custom trait hint field and value for key member's trait") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj2.read[Map[(PetHolder, PetHolder), (PetHolder, PetHolder)]](yaml)
      }
    }
    it("Parameterized class") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj.read[Map[(AThing[Int, String], AThing[Int, String]), (AThing[Int, String], AThing[Int, String])]](yaml)
      }
    }
    it("Parameterized trait") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj.read[Map[(Thing[String, Int], Thing[String, Int]), (Thing[String, Int], Thing[String, Int])]](yaml)
      }
    }
    it("Parameterized trait having parameterized trait members") {
      ...
      assertResult(comparison) { yaml }
      assertResult(inst) {
        sj.read[Map[(Thing[String, Part[Double]], Thing[String, Part[Double]]), (Thing[String, Part[Double]], Thing[String, Part[Double]])]](yaml)
      }
    }
  }
}
