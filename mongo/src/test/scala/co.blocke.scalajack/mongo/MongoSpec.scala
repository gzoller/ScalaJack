...
class MongoSpec extends AnyFunSpec with Matchers {
    ...
    "---------------------------\n:  Mongo Tests (MongoDB)  :\n---------------------------"
      ...
      describe("Basic Collection Support") {
        it(
          "Case class having List parameter - Foo[A](x:A) where A -> List of simple type"
            ...
            db.asDocument.toJson should equal(
        ...
        it(
          "Case class having Option parameter - Foo[A](x:A) where A -> Option of simple type"
            ...
            db2.asDocument.toJson should equal(
        ...
        "Advanced Collection Support - collections of parameterized case class"
          ...
          it(
            "Case class having Map parameter - Foo[A](x:A) where A -> Map of Bar[Int,String]"
              ...
              mongoScalaJack.read[Carry[Map[String, Zoo[Boolean]]]](db) should equal(
                w
              )
            }
          it(
      ...
      describe("Basic trait support") {
        ...
        it("Hint modifier fails") {
          ...
          val db = scalaJack.render(w)
          the[ScalaJackError] thrownBy scalaJack.read[Carry[Pop]](db) should have message "Couldn't marshal class for Wow2"
        }
        it("Type modifier works") {
          ...
          d.asDocument.toJson should be(
            """{"Giraffe": "Body", "id": "DEF", "body": {"_hint": "co.blocke.scalajack.mongo.FancyBody", "message": "BOO"}}"""
          )
      ...
      describe(
        "Advanced trait support -- parameters are traits, themselves having parameters"
          ...
          it("Parameter is Map of String->parameterized trait") {
            ...
            mongoScalaJack.read[Carry[Map[String, Tart[String]]]](db) should equal(
              w
            )
          }
      ...
      describe("Annotations (e.g. DBKey)") {
        ...
        it(
          "DBKey Annotation (_id field generation) - single key -- Missing Non-Key Field"
            ...
            val msg = """Class Two missing required fields: foo""".stripMargin
            the[ScalaJackError] thrownBy mongoScalaJack.read[Five](dbo) should have message msg
          }
        it(
        ...
        it(
          "DBKey Annotation (_id field generation) - compound key -- Missing Key Field component"
            ...
            val msg =
              """Missing key (_id) field, or a component of a compound key field: num"""
            the[ScalaJackError] thrownBy mongoScalaJack.read[Six](dbo) should have message msg
          }
      }
      ...
      describe("Advanced Parameterized Case Class") {
        it(
          "Parameterized case class as parameter - Foo[A](x:A) where A -> Bar[Int]"
            ...
            db3.asDocument.toJson should equal(
        ...
        it(
          "Case class having value class parameter - Foo[A](x:A) where A -> value class (no value class handler)"
            ...
            val db = mongoScalaJack.render(w)
            db.asDocument.asDocument.toJson should equal(
